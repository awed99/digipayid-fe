          ...
          <Grid container spacing={2}>
            <Grid item xs={6}>
              <CardStatisticsVerticalComponent
                stats={format_rupiah(data?.trends?.pendapatan)}
                icon={<Poll />}
                color='success'
                trendNumber='100%'
            ...
            <Grid item xs={6}>
              <CardStatisticsVerticalComponent
                stats={format_rupiah(data?.trends?.pembelian)}
            ...
            <Grid item xs={6}>
              <CardStatisticsVerticalComponent
                stats={format_rupiah(data?.trends?.deposit)}
                icon={<CurrencyUsd />}
                color='primary'
                // trend='negative'
                trendNumber='100%'
            ...
            <Grid item xs={6}>
              <CardStatisticsVerticalComponent
                stats={format_rupiah(data?.trends?.withdraw)}
                icon={<CurrencyUsd />}
                // trend='negative'
                color='error'
                trendNumber='100%'
