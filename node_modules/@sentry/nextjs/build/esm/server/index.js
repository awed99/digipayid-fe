...
import { applySdkMetadata, getGlobalScope, getClient } from '@sentry/core';
...
import { httpIntegration } from './httpIntegration.js';
  ...
  getGlobalScope().addEventProcessor(
    Object.assign(
      ((event, hint) => {
        ...
        const exceptionMessage = _optionalChain([event, 'access', _10 => _10.exception, 'optionalAccess', _11 => _11.values, 'optionalAccess', _12 => _12[0], 'optionalAccess', _13 => _13.value]);
        if (
          _optionalChain([exceptionMessage, 'optionalAccess', _14 => _14.includes, 'call', _15 => _15('Suspense Exception: This is not a real error!')]) ||
          _optionalChain([exceptionMessage, 'optionalAccess', _16 => _16.includes, 'call', _17 => _17('Suspense Exception: This is not a real error, and should not leak')])
        ) {
          return null;
        }
...
export { ErrorBoundary, createReduxEnhancer, httpIntegration, init, showReportDialog, withErrorBoundary };
