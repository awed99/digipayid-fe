;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="861d80e4-d2ad-4bbb-a581-9cdab2760669",e._sentryDebugIdIdentifier="sentry-dbid-861d80e4-d2ad-4bbb-a581-9cdab2760669")}catch(e){}}();
"use strict";
(() => {
var exports = {};
exports.id = 6645;
...
function setSession(req, res) {
  const {
    email
  } = JSON.parse(req.body); // Then save the post data to a database

  store__WEBPACK_IMPORTED_MODULE_1___default().remove(email);
  res.status(200).json({
...
if (wrappedHandler) {
  wrappedHandler = _sentry_nextjs__WEBPACK_IMPORTED_MODULE_0__.wrapApiHandlerWithSentry(wrappedHandler, '/api/remove-storage');
}
...
var __webpack_exports__ = (__webpack_exec__(9552));
module.exports = __webpack_exports__;

})();
//# sourceMappingURL=remove-storage.js.map