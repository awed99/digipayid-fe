;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="820df286-945f-4ffa-8c91-afe99c0b4dec",e._sentryDebugIdIdentifier="sentry-dbid-820df286-945f-4ffa-8c91-afe99c0b4dec")}catch(e){}}();
"use strict";
(() => {
var exports = {};
exports.id = 9957;
...
async function setSession(req, res) {
  ...
  await store__WEBPACK_IMPORTED_MODULE_1___default().set(key, val);
  res.status(200).json({
    [key]: val,
...
if (wrappedHandler) {
  wrappedHandler = _sentry_nextjs__WEBPACK_IMPORTED_MODULE_0__.wrapApiHandlerWithSentry(wrappedHandler, '/api/set-storage');
}
...
var __webpack_exports__ = (__webpack_exec__(3603));
module.exports = __webpack_exports__;

})();
//# sourceMappingURL=set-storage.js.map