;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="908ade6f-8e79-48bb-847d-d9ec432a1d63",e._sentryDebugIdIdentifier="sentry-dbid-908ade6f-8e79-48bb-847d-d9ec432a1d63")}catch(e){}}();
"use strict";
(() => {
var exports = {};
exports.id = 7869;
...
async function GET(req, res) {
  const {
    email
  } = JSON.parse(req.body); // console.log('email: ', email)
  // console.log('store.get(req.body): ', store.get(email))

  const auth = await store__WEBPACK_IMPORTED_MODULE_1___default().get(email);
  const data = req.body;
  res.status(200).json({
    auth: auth,
...
if (wrappedHandler) {
  wrappedHandler = _sentry_nextjs__WEBPACK_IMPORTED_MODULE_0__.wrapApiHandlerWithSentry(wrappedHandler, '/api/check-auth');
}
